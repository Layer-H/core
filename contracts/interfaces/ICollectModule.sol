...
interface ICollectModule {
     ...
     * @param pubId The associated publication's HealthHub publication ID.
     ...
     *
     * @param referrerProfileId The HealthHub profile token ID of the referrer's profile (only different in case of mirrors).
     * @param collector The collector address.
     * @param profileId The token ID of the profile associated with the publication being collected.
     * @param pubId The HealthHub publication ID associated with the publication being collected.
