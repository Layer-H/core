 ...
 * @author Layer-H
 *
 * @notice This is the interface for the HealthHub contract, the main entry point for the Layer-H.
 * You'll find all the events and external functions, as well as the reasoning behind them here.
 */
interface IHealthHub {
    /**
     * @notice Initializes the HealthHub NFT, setting the initial governance address as well as the name and symbol in
     * the HealthNFTBase contract.
     *
