...
/**
 * @title HealthMultiState
 *
 * @notice This is an abstract contract that implements internal HealthHub state setting and validation.
 *
 * whenNotPaused: Either publishingPaused or Unpaused.
 * whenPublishingEnabled: When Unpaused only.
 */
abstract contract HealthMultiState {
